...
export const USE_CASES: Record<string, UseCase> = {
  ...
  "teachers": {
    slug: "teachers",
    audience: "teachers",
    title: "AI tools for teachers — worksheets, coloring pages, certificates, slides",
    tagline: "Make classroom materials in minutes instead of your evenings — printable coloring pages, award certificates, flashcards, and lesson slides in one place.",
    intro: "Teachers spend hours of unpaid time every week building materials, and pay out of pocket on marketplaces for the rest. DreamForgeX puts a whole classroom production line in one workspace. Describe a theme and get printable coloring and activity pages, generate award and completion certificates with a student's name, build flashcard-style cards for any subject, and lay out lesson slides without fighting a template. Everything exports print-ready, so you go from idea to handout before the bell. No design skills, no marketplace subscriptions, and every output is yours to use in your classroom.",
    painPoints: [
      "Hours of unpaid prep time making worksheets and visuals every week",
      "Paying out of pocket on teacher-marketplace downloads",
      "Generic clip-art that doesn't match the lesson",
      "Certificates, flashcards, and slides each living in a different tool",
    ],
    tools: [
      { slug: "coloring-book", why: "Printable line-art coloring and activity pages on any theme or vocabulary set." },
      { slug: "certificate", why: "Award, completion, and good-behavior certificates with a student's name in seconds." },
      { slug: "presentations", why: "Lesson slide decks laid out from your outline — no template wrestling." },
      { slug: "trading-card", why: "Flashcard-style cards for vocab, historical figures, science terms, or sight words." },
      { slug: "sticker-pack", why: "Reward and incentive sticker sheets for the classroom economy." },
      { slug: "bookmark", why: "Reading-reward bookmarks to print and hand out." },
      { slug: "invitation", why: "Open-house, field-trip, and class-event invitations for parents." },
      { slug: "icon-gen", why: "Clean visual aids and labels for centers, schedules, and word walls." },
    ],
    outcome: "In a single prep period you can: print a themed worksheet and coloring set, run off a stack of named certificates, build a flashcard deck for the unit, and finish your lesson slides — all classroom-ready, all without leaving one tab.",
  },

  "musicians": {
    slug: "musicians",
    audience: "musicians",
    title: "AI tools for musicians — album covers, music videos, gig posters, promo",
    tagline: "Package and promote your music without a label's design budget — album and single covers, lyric and music videos, gig posters, and social art in one place.",
    intro: "Releasing music is half the work; getting people to hear it is the other half, and that half is design. Most independent musicians cobble together a cover artist, a video editor, a poster template, and a social scheduler — or just ship something that looks rushed. DreamForgeX gives you the whole visual rollout in one workspace. Generate a streaming-ready cover for a single or album, turn a track into a lyric or music video, design tour and gig posters, and batch the social art for the release — all matched to one look. Spend your time on the music and still show up looking like a label put you out.",
    painPoints: [
      "Cover art that looks amateur next to playlist neighbors",
      "No budget for a designer, video editor, and photographer per release",
      "Gig posters and social art that don't share a consistent look",
      "Turning a finished track into shareable video content",
    ],
    tools: [
      { slug: "cover-maker", why: "Streaming-ready square cover art for a single, EP, or album." },
      { slug: "music-video", why: "Turn a track into a lyric or visualizer-style music video." },
      { slug: "concert-poster", why: "Gig, tour, and release-show posters in a cohesive style." },
      { slug: "social-templates", why: "Release-day posts for Reels, TikTok, and Stories." },
      { slug: "clip-maker", why: "Pull the most-shareable snippets for short-form promo." },
      { slug: "yt-thumbnails", why: "Click-worthy thumbnails for video uploads and visualizers." },
      { slug: "logo-maker", why: "An artist or band logo for merch, covers, and socials." },
      { slug: "text-effects", why: "Stylized lyric and title graphics for posts and videos." },
      { slug: "brand-style-guide", why: "Lock your colors and type so every release looks like you." },
    ],
    outcome: "From a finished track you can ship a full rollout in an evening: cover art, a lyric video, a release poster, matching social posts, and a thumbnail — one consistent look, all yours to publish anywhere.",
  },

  "dnd-players": {
    slug: "dnd-players",
    audience: "D&D and tabletop RPG players",
    title: "AI art for D&D and tabletop RPGs — character portraits, item cards, NPC art",
    tagline: "Bring your campaign to life — character portraits, monster and item cards, NPC faces, and location concept art for your next session.",
    intro: "Commissioned art for a tabletop campaign is expensive and slow, and stock fantasy art never quite matches the character in your head. DreamForgeX lets players and dungeon masters generate exactly what the table needs, on demand. Turn a character concept into a portrait, give every NPC a face, design spell and magic-item cards, build a monster-card deck for the next dungeon, and sketch out the look of a tavern, keep, or ruin before the party arrives. Roll your own margin doodle into finished art, or describe it from scratch. It's the art budget of a campaign you actually run, generated session by session.",
    painPoints: [
      "Commissioned character art is expensive and takes weeks",
      "Stock fantasy art never matches the character you actually rolled",
      "Every NPC and location needs a face the party can picture",
      "Handouts — item cards, spell cards, monster cards — take forever to make",
    ],
    tools: [
      { slug: "character-sheet", why: "Turn a character concept into a portrait that matches the build." },
      { slug: "avatar", why: "Quick faces and tokens for the NPCs your party keeps meeting." },
      { slug: "tarot-card", why: "Spell, magic-item, and fate-style cards as table handouts." },
      { slug: "trading-card", why: "Monster and item card decks for encounters and loot." },
      { slug: "architecture-concept", why: "Concept art for taverns, dungeons, keeps, and ruined locations." },
      { slug: "pose-turnaround", why: "Multiple angles of a hero or villain for a reference sheet." },
      { slug: "sketch-to-image", why: "Turn a rough doodle into finished fantasy art." },
      { slug: "cover-maker", why: "A cover for your homebrew campaign or one-shot handbook." },
    ],
    outcome: "Before the next session you can: portrait the whole party, give three NPCs a face, print a deck of item and monster cards, and concept the dungeon they're about to enter — a custom art kit for your table, generated in an hour.",
  },

  "fitness-coaches": {
    slug: "fitness-coaches",
    audience: "fitness coaches and personal trainers",
    title: "AI tools for fitness coaches — branding, social content, ads, client graphics",
    tagline: "Look like an established brand from day one — logo, social posts, program covers, ads, and profile photos, all on one consistent look.",
    intro: "A coaching business lives and dies on how it looks in a feed. But most trainers don't have time between clients to design posts, build a brand, and write ads — and agencies are out of budget early on. DreamForgeX gives a coach a full marketing department in one workspace. Build a logo and a brand kit, then turn out daily social posts, challenge and bootcamp flyers, program-guide covers, and ad creative that all share the same look. Even a clean profile headshot to front it. Show up looking like a brand clients trust, without hiring one.",
    painPoints: [
      "No time between clients to design content and ads",
      "Posts that look inconsistent and off-brand across platforms",
      "Agency and freelancer design costs that don't fit an early budget",
      "Needing flyers and graphics for every challenge, promo, and launch",
    ],
    tools: [
      { slug: "logo-maker", why: "A coaching logo and variations for socials, PDFs, and merch." },
      { slug: "brand-style-guide", why: "Lock your colors and type so every asset looks like one brand." },
      { slug: "social-templates", why: "Daily post and Story templates for tips, wins, and offers." },
      { slug: "ig-carousel", why: "Educational and transformation carousels that drive saves and follows." },
      { slug: "ad-copy", why: "Ad and caption copy for challenges, lead magnets, and launches." },
      { slug: "headshot", why: "A clean, professional profile photo to front the brand." },
      { slug: "thumbnail", why: "Thumbnails for YouTube workouts or a course module." },
      { slug: "event-flyer", why: "Bootcamp, challenge, and class-promo flyers." },
      { slug: "business-card", why: "Matching cards for gyms, expos, and referrals." },
    ],
    outcome: "In one sitting you can stand up a brand: logo and brand kit, a week of on-brand social posts, a challenge flyer, an ad, and a profile headshot — everything matched, everything client-ready.",
  },

  "wedding-planners": {
    slug: "wedding-planners",
    audience: "wedding planners and couples",
    title: "AI tools for weddings — invitations, save-the-dates, menus, signage",
    tagline: "DIY a designer-level wedding suite — invitations, save-the-dates, menus, signage, and thank-you cards — coordinated to one theme for a fraction of a stationer's price.",
    intro: "A wedding is a hundred small design jobs: save-the-dates, invitations, menus, programs, table signage, favors, and thank-you cards — and a custom stationer charges accordingly. DreamForgeX lets a planner or a couple produce the whole paper suite themselves, coordinated to one palette and style. Pick a theme and generate matching invitations and save-the-dates, lay out reception menus, design welcome and seating signage, and finish with thank-you cards after the day. You can even restore and colorize an old family photo for the display table. One look across everything, print-ready, at a fraction of bespoke-stationery cost.",
    painPoints: [
      "Custom wedding stationery runs hundreds to thousands of dollars",
      "Keeping invitations, menus, signage, and favors visually consistent",
      "Templates that everyone else's wedding also used",
      "Last-minute day-of signage with no time for a designer",
    ],
    tools: [
      { slug: "invitation", why: "Invitations and save-the-dates matched to your theme." },
      { slug: "menu-design", why: "Reception and bar menus laid out to the same look." },
      { slug: "greeting-card", why: "Thank-you cards to send after the day." },
      { slug: "event-flyer", why: "Welcome signs, programs, and day-of signage." },
      { slug: "business-card", why: "Place cards and escort cards for the tables." },
      { slug: "bookmark", why: "Printable favors and ceremony keepsakes." },
      { slug: "collage", why: "Photo-display collages for the welcome table or slideshow." },
      { slug: "brand-style-guide", why: "Pin the palette and type so every piece coordinates." },
      { slug: "photo-restore", why: "Restore and colorize old family photos for the memory table." },
    ],
    outcome: "From one theme you can build the whole suite: save-the-dates, invitations, menus, signage, place cards, and thank-you cards — all coordinated, all print-ready, for the cost of a single bespoke item.",
  },
};
