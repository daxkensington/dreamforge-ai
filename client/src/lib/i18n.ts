...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "hero.subtitle": "68+ AI tools for images, video, songs, and design — powered by 20 AI models",
  ...
  es: {
    ...
    "hero.subtitle": "68+ herramientas de IA para imágenes, video, canciones y diseño — impulsado por 20 modelos de IA",
  ...
  fr: {
    ...
    "hero.subtitle": "68+ outils IA pour images, vidéo, chansons et design — propulsé par 20 modèles IA",
  ...
  de: {
    ...
    "hero.subtitle": "68+ KI-Tools für Bilder, Video, Songs und Design — angetrieben von 20 KI-Modellen",
  ...
  zh: {
    ...
    "hero.subtitle": "68+AI工具，用于图像、视频、歌曲和设计——由20个AI模型驱动",
    "cta.start_free": "免费开始",
    "cta.generate": "生成",
    "cta.download": "下载",
    "pricing.free": "免费",
  ...
  pt: {
    ...
    "hero.subtitle": "68+ ferramentas de IA para imagens, vídeo, músicas e design",
