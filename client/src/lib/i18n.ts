...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "hero.subtitle": "100+ AI tools for images, video, songs, and design — powered by 30+ AI models",
  ...
  es: {
    ...
    "hero.subtitle": "100+ herramientas de IA para imágenes, video, canciones y diseño — impulsado por 30+ modelos de IA",
  ...
  fr: {
    ...
    "hero.subtitle": "100+ outils IA pour images, vidéo, chansons et design — propulsé par 30+ modèles IA",
  ...
  de: {
    ...
    "hero.subtitle": "100+ KI-Tools für Bilder, Video, Songs und Design — angetrieben von 30+ KI-Modellen",
  ...
  zh: {
    ...
    "hero.subtitle": "100+AI工具，用于图像、视频、歌曲和设计——由30+个AI模型驱动",
    "cta.start_free": "免费开始",
    "cta.generate": "生成",
    "cta.download": "下载",
    "pricing.free": "免费",
  ...
  pt: {
    ...
    "hero.subtitle": "100+ ferramentas de IA para imagens, vídeo, músicas e design",
