                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 divide-x divide-border/50">
                      ...
                      <div className="p-4">
                        <Badge className="mb-3 bg-amber-500/20 text-amber-400 border-amber-500/30">
                          {resultUrl ? activeEffect?.label || "Processed" : "Result"}
                        </Badge>
                        <div className="rounded-lg overflow-hidden bg-muted/30 border border-border/30 min-h-[200px] flex items-center justify-center">
                          <AnimatePresence mode="wait">
                            {isProcessing ? (
                              ...
                              <motion.img key="result" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} src={resultUrl} alt="Processed" className="w-full h-auto max-h-[350px] object-contain" />
                            ) : (
