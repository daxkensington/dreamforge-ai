    ...
    <ToolPageLayout title="Social Media Resizer" description="Resize images for any social media platform" icon={Share2} gradient="from-blue-500 to-indigo-400">
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 p-3 rounded-xl bg-white/5 border border-white/10">
          ...
          <img loading="lazy" src="/showcase/tool-social.jpg" alt="Social media resizing" className="w-full rounded-lg max-h-48 object-cover" />
        </div>
                          ...
                          <AnimatePresence mode="wait">
                            {isProcessing ? (
                              ...
                              <motion.div key="result" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
                                <img loading="lazy" src={resultUrl} alt="Resized" className="w-full h-auto max-h-[300px] object-contain" />
                              </motion.div>
                            ) : (
