    ...
    <ToolPageLayout title="Depth Map Generator" description="Extract depth information from any image" icon={Layers} gradient="from-gray-500 to-blue-400">
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 p-3 rounded-xl bg-white/5 border border-white/10">
          ...
          <img loading="lazy" src="/showcase/tool-depthmap.jpg" alt="3D depth map" className="w-full rounded-lg max-h-48 object-cover" />
        </div>
                          ...
                          <AnimatePresence mode="wait">
                            {isProcessing ? (
                              ...
                              <motion.div key="result" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
                                <img loading="lazy" src={resultUrl} alt="Depth Map" className="w-full h-auto max-h-[300px] object-contain" />
                              </motion.div>
                            ) : (
